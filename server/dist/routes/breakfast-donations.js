...
const breakfastDonationSchema = zod_1.z.object({
    donorName: zod_1.z.string().min(1),
    schoolId: zod_1.z.string().min(1),
    supplierId: zod_1.z.string().min(1),
    selectedWeeks: zod_1.z.array(zod_1.z.string()),
    totalAmount: zod_1.z.number().int().positive(),
    costPerStudent: zod_1.z.number().int().positive().optional(),
    studentCount: zod_1.z.number().int().positive(),
